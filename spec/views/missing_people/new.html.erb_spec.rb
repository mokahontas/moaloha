...
RSpec.describe "missing_people/new", type: :view do
  before(:each) do
    assign(:missing_person, MissingPerson.new(
      :first_name => "MyString",
      :last_name => "MyString",
      :sex => "MyString",
      :location => "MyText",
  ...
  it "renders new missing_person form" do
    render

    assert_select "form[action=?][method=?]", missing_people_path, "post" do
