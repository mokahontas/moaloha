...
RSpec.describe ImpressionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested impression as @impression" do
      impression = Impression.create! valid_attributes
      get :show, params: {id: impression.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested impression as @impression" do
      impression = Impression.create! valid_attributes
      get :edit, params: {id: impression.to_param}, session: valid_session
      expect(assigns(:impression)).to eq(impression)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Impression" do
        expect {
          post :create, params: {impression: valid_attributes}, session: valid_session
      ...
      it "redirects to the created impression" do
        post :create, params: {impression: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Impression.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved impression as @impression" do
        post :create, params: {impression: invalid_attributes}, session: valid_session
        expect(assigns(:impression)).to be_a_new(Impression)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested impression" do
        impression = Impression.create! valid_attributes
        put :update, params: {id: impression.to_param, impression: new_attributes}, session: valid_session
        impression.reload
      ...
      it "assigns the requested impression as @impression" do
        impression = Impression.create! valid_attributes
        put :update, params: {id: impression.to_param, impression: valid_attributes}, session: valid_session
        expect(assigns(:impression)).to eq(impression)
      end
      ...
      it "redirects to the impression" do
        impression = Impression.create! valid_attributes
        put :update, params: {id: impression.to_param, impression: valid_attributes}, session: valid_session
        expect(response).to redirect_to(impression)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the impression as @impression" do
        impression = Impression.create! valid_attributes
        put :update, params: {id: impression.to_param, impression: invalid_attributes}, session: valid_session
        expect(assigns(:impression)).to eq(impression)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested impression" do
      impression = Impression.create! valid_attributes
      expect {
        delete :destroy, params: {id: impression.to_param}, session: valid_session
      }.to change(Impression, :count).by(-1)
    end
